    ...
    for stage in stages:
        for entry in data_list:
            ...
            if entry["variable_type"] == "optimal":
                optimal_betsize_list = entry["data"][stage]
                optimal_betsize_list = remove_nulls(optimal_betsize_list)
            
        correlation_coefficient, p_value = calculate_correlation(observation_betsize_list, optimal_betsize_list)
        mae = calculate_mae(observation_betsize_list, optimal_betsize_list)
...
if __name__ == "__main__":
    ...
    mae_total_f = 0
    correlation_coefficient_total_f = 0
    p_value_total_f = 0
    mae_total_t = 0
    correlation_coefficient_total_t = 0
    p_value_total_t = 0
    mae_total_r = 0
    correlation_coefficient_total_r = 0
    p_value_total_r = 0
    ...
    for player in player_of_interest:
        ...
        correlation_coefficient_total_f += interaction_dicts[player]['f']['correlation_coefficient']
        correlation_coefficient_total_t += interaction_dicts[player]['t']['correlation_coefficient']
        correlation_coefficient_total_r += interaction_dicts[player]['r']['correlation_coefficient']
        p_value_total_f += interaction_dicts[player]['f']['p_value']
        p_value_total_t += interaction_dicts[player]['t']['p_value']
        p_value_total_r += interaction_dicts[player]['r']['p_value']

    total = len(player_of_interest)
    avg_mae_f = mae_total_f/total
    avg_mae_t = mae_total_t/total
    avg_mae_r = mae_total_r/total
    avg_correlation_coefficient_f = correlation_coefficient_total_f/total
    avg_correlation_coefficient_t = correlation_coefficient_total_t/total
    avg_correlation_coefficient_r = correlation_coefficient_total_r/total
    avg_p_value_f = p_value_total_f/total
    avg_p_value_t = p_value_total_t/total
    avg_p_value_r = p_value_total_r/total
