...
if __name__ == "__main__":
    ...
    file_path = f"/home/app/tetsu_k/aotm_project/data/hands_valid_3.json"
    with open(file_path, 'r') as file:
            # Load the JSON data from the file
            data_list = [json.loads(line) for line in file]
            # Iterate through the data
            for entry in data_list:
                if entry["id"] >= 225619 and entry["id"] < 229619:
                    ...
                    if entry["num_players"] == 2:
                        for user_dict in entry["players"]:
                            ...
                            if user in users_to_extract:
                                ...
                                with open(f'/home/app/tetsu_k/aotm_project/data/data_per_player/data_{user}.json', 'a') as json_file:
